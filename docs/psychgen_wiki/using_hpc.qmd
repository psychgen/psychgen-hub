...
Colossus is the TSD HPC cluster and is offered by UiO in collaboration with Sigma2 AS. [UiO's Colossus User Guide](https://docs.hpc.uio.no/hardware/colossus.html) includes detailed information about working with Colossus.

### Getting started ### 

The easiest way to access the HPC is by using Putty (found on the desktop) - check out [this userguide](https://www.uio.no/english/services/it/research/sensitive-data/help/hpc/windows-user.html) if you need help. 

Check out [this guide](https://docs.hpc.uio.no/getting_started/R.html) for submitting your first R job 
